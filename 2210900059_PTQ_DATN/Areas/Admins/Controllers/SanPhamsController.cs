...
namespace _2210900059_PTQ_DATN.Areas.Admins.Controllers
{
    ...
    public class SanPhamsController : Controller
    {
        ...
        public SanPhamsController(LeSkinDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaSanPham,MaDanhMuc,TenSanPham,Slug,LoaiSanPham,ThuongHieu,DungTich,DoiTuongSuDung,CongDungChinh,ThanhPhanNoiBat,MoTaNgan,MoTaChiTiet,HinhAnh,Gia,NoiBat,NgayTao,TrangThai,MaNguoiTao,MaNguoiCapNhat")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaSanPham,MaDanhMuc,TenSanPham,Slug,LoaiSanPham,ThuongHieu,DungTich,DoiTuongSuDung,CongDungChinh,ThanhPhanNoiBat,MoTaNgan,MoTaChiTiet,HinhAnh,Gia,NoiBat,NgayTao,TrangThai,MaNguoiTao,MaNguoiCapNhat")] SanPham sanPham)
        {
